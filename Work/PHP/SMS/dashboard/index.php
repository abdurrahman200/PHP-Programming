...
<body>
  <nav class="navbar fixed-top flex-md-nowrap p-0 shadow-sm">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#"> <img src="img/Me.png" alt="me" width="30px"> Abdur rahman </a>
    <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search">
    <ul class="navbar-nav px-3">
      <li class="nav-item text-nowrap">
        <a class="nav-link" href="#" style="color: #fff;">Sign out</a>
      </li>
    </ul>
  </nav>
