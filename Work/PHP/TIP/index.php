...
<head>
    ...
    <link rel="stylesheet" href="polytechnic/css/bootstrap.min.css">
    <link rel="stylesheet" href="polytechnic/css/font-awesome.min.css">
    <link rel="stylesheet" href="polytechnic/css/slick.css">
    <link rel="stylesheet" href="polytechnic/css/style.css">
    <link rel="stylesheet" href="polytechnic/css/responsive.css">
</head>
<body>
    <div id="home">
        <!--  head part starts  -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-7 col-12 logo">
                        <a href="#">
                            <img src="polytechnic/images/logo.png" alt="" class="img-fluid">
                        </a>
                    </div>
        ...
        <section id="banner">
            <div class="slide">
                <div class="bim-1">
                    <img src="polytechnic/images/banner.jpg" alt="" class="img-fluid">
                </div>
                <div class="bim-2">
                    <img src="polytechnic/images/banner2.jpg" alt="" class="img-fluid">
                </div>
            </div>
        </section>
        <!-- banner ends -->
                ...
                <div class="col-md-8 col-sm-12 col-12">
                    ...
                    <div class="princi row">
                        ...
                        <div class="col-md-2 col-sm-3 p-sm-0 col-12">
                            <img class="img-fluid" src="polytechnic/images/princi.jpg" alt="">
                        </div>
                        ...
                        <div class="col-md-12 col-12 col-sm-4">
                            <div class="notice">
                                ...
                                <div class="note-slick">
                                    ...
                                    $notice_get ="SELECT * FROM noticetable";

                                    $notice_get_result =  mysqli_query($db_connect,$notice_get);

                                        // print_r($notice_get_result);

                                    foreach ($notice_get_result as $value) {
                                        ...
                                        <div class="note col-md-12 col-sm-12 col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-11 col-sm-11 col-11 p-0 n">
                                                    <h6 style="display: inline-block"><a href="notice.html" target="_blank"> <?=$value['Notice_Title']?> </a></h6>
                                                    <p><a href="notice.html" target="_blank"><i class="fa fa-calendar"></i> <?=$value['Notice_Date']?></a></p>

                                                    <p><?=$value['Notice_Massage']?></p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-6 blog-item">
                    <div>
                        <img src="polytechnic/images/b-1.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="blog-d">
                ...
                <div class="col-md-4 col-sm-4 col-6 blog-item">
                    <div>
                        <img src="polytechnic/images/b2.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="blog-d">
                        <h3> program in the auditorium</h3>
                        <i class="fa fa-user"></i> Admin
                ...
                <div class="col-md-4 col-sm-4 col-6 disp blog-item">
                    <div>
                        <img src="polytechnic/images/b3.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="blog-d">
                        <h3> program in the auditorium</h3>
                        <i class="fa fa-user"></i> Admin
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6 col-6">
                    <img src="polytechnic/images/logo-small.png" alt="" class="img-fluid">
    ...
    <script src="polytechnic/js/jquery-1.12.4.min.js"></script>
    <script src="polytechnic/js/bootstrap.min.js"></script>
    <script src="polytechnic/js/mixitup.min.js"></script>
    <script src="polytechnic/js/slick.min.js"></script>
    <script src="polytechnic/js/custom.js"></script>
</body>
</html>